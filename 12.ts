//Solution
type FindSanta<Type extends Array<any>, Checked extends Array<any> =[]> = Type extends [infer First, ...infer Rest] ?
	First extends '🎅🏼' ? Checked['length'] : FindSanta<Rest, [First, ...Checked]> : never;
