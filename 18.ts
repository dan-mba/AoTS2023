//Solution
type Count<Sack extends Array<any>, Toy extends string, arr extends Array<string>=[]> = Sack extends [infer First, ...infer Rest]?
	First extends Toy ? Count<Rest, Toy, [First, ...arr]> :  Count<Rest, Toy, arr> : arr["length"];
