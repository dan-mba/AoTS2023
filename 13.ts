//Solution
type range<T extends number, R extends Array<number> = []> = T extends R["length"] ? R[number] : range<T, [...R, R["length"]]>;

type DayCounter<Start extends number, End extends number> = Exclude<range<End>, range<Start>> | End;
